...
L["Show the tooltip line even when the item is not in the database"] = "Zeigen Sie die Tooltip-Zeile auch dann an, wenn sich das Item nicht in der Datenbank befindet"
...
L["Opens a window with information to assist in creating an issue"] = "Öffnet ein Fenster mit Informationen, die bei der Erstellung eines Problems helfen"
...
L["Copy and paste this data when making a new issue for ItemVersion."] = "Kopieren Sie diese Daten und fügen Sie sie ein, wenn Sie eine neue Ausgabe für ItemVersion erstellen."
